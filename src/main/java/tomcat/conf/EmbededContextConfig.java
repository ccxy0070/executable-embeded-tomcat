...
public class EmbededContextConfig extends ContextConfig {
	 ...
	 * If static resources are found, add them to the context. Resources are added in web-fragment.xml priority order.
	 */
	@Override
		...
		for (WebXml fragment : fragments) {
			...
			try {
				...
				if (isInsideNestedJar(urlString)) {
					...
					// Tomcat is going to try and locate it as a root URL (not the resource inside it)
